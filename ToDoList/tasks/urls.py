...
from .views import AtualizarPerfil, VisualizarTarefa, Pomodoro, CriarTarefa, AtualizarTarefa, ConcluirTarefa, ExcluirTarefa, ListarTarefa, Login, CadastroUsuario, SairView
...
urlpatterns = [
    ...
    path('visualizartarefa', VisualizarTarefa.as_view(), name='visualizartarefa')
